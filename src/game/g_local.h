...
struct client_s {
    ...
    menu_t menu;
    struct {
        FLOAT bounds[8]; // x1, y1, x2, y2, x3, y3, x4, y4
        CAMERASETUP state;
...
struct gevent_s {
    ...
    EVENTTYPE type;
    LPTRIGGER trigger;
    LPCSTR chatMessage; // for EVENT_PLAYER_CHAT
    BOOL exactMatchOnly; // for EVENT_PLAYER_CHAT
    LPCSTR varName; // for EVENT_GAME_VARIABLE_LIMIT, EVENT_GAME_STATE_LIMIT
    HANDLE trackable; // for EVENT_GAME_TRACKABLE_HIT, EVENT_GAME_TRACKABLE_TRACK
    HANDLE button; // for EVENT_DIALOG_BUTTON_CLICK
    HANDLE gamestate; // for EVENT_GAME_STATE_LIMIT
    HANDLE limitop; // for EVENT_GAME_STATE_LIMIT
    FLOAT limitval; // for EVENT_GAME_STATE_LIMIT
    LPEDICT target; // for EVENT_PLAYER_UNIT_ISSUED_ORDER, EVENT_PLAYER_UNIT_ISSUED_POINT_ORDER, EVENT_PLAYER_UNIT_ISSUED_TARGET_ORDER
    LPEDICT source; // for EVENT_PLAYER_UNIT_ISSUED_ORDER, EVENT_PLAYER_UNIT_ISSUED_POINT_ORDER, EVENT_PLAYER_UNIT_ISSUED_TARGET_ORDER
    LPEVENT responseTo; // for responses to events
    LPEVENT nextResponse; // for responses to this event
    LPEDICT unit; // for EVENT_PLAYER_UNIT_ATTACKED, EVENT_PLAYER_UNIT_RESCUED, EVENT_PLAYER_UNIT_DEATH, EVENT_PLAYER_UNIT_DECAY, EVENT_PLAYER_UNIT_DETECTED, EVENT_PLAYER_UNIT_HIDDEN, EVENT_PLAYER_UNIT_SELECTED, EVENT_PLAYER_UNIT_DESELECTED, EVENT_PLAYER_UNIT_CONSTRUCT_START, EVENT_PLAYER_UNIT_CONSTRUCT_CANCEL, EVENT_PLAYER_UNIT_CONSTRUCT_FINISH, EVENT_PLAYER_UNIT_UPGRADE_START, EVENT_PLAYER_UNIT_UPGRADE_CANCEL, EVENT_PLAYER_UNIT_UPGRADE_FINISH, EVENT_PLAYER_UNIT_TRAIN_START, EVENT_PLAYER_UNIT_TRAIN_CANCEL, EVENT_PLAYER_UNIT_TRAIN_FINISH, EVENT_PLAYER_UNIT_RESEARCH_START, EVENT_PLAYER_UNIT_RESEARCH_CANCEL, EVENT_PLAYER_UNIT_RESEARCH_FINISH
    LPEVENT dialog; // for dialog events
    LPEDICT dialogButton; // for EVENT_DIALOG_BUTTON_CLICK
    LPEDICT dialogClick; // for EVENT_DIALOG_CLICK
    LPEDICT item; // for EVENT_UNIT_DROP_ITEM, EVENT_UNIT_PICKUP_ITEM, EVENT_UNIT_USE_ITEM
    LPEDICT targetItem; // for EVENT_PLAYER_UNIT_DROP_ITEM, EVENT_PLAYER_UNIT_PICKUP_ITEM, EVENT_PLAYER_UNIT_USE_ITEM
    LPEDICT sourceItem; // for EVENT_PLAYER_UNIT_DROP_ITEM, EVENT_PLAYER_UNIT_PICKUP_ITEM, EVENT_PLAYER_UNIT_USE_ITEM
    LPEVENT nextDialog; // for dialog events
    LPEVENT nextDialogButton; // for dialog button events
    LPEVENT nextDialogClick; // for dialog click events
    LPEVENT nextItem; // for item events
    LPEVENT nextTargetItem; // for target item events
    LPEVENT nextSourceItem; // for source item events
    LPEDICT player; // for EVENT_PLAYER_STATE_LIMIT, EVENT_PLAYER_ALLIANCE_CHANGED, EVENT_PLAYER_DEFEAT, EVENT_PLAYER_VICTORY, EVENT_PLAYER_LEAVE, EVENT_PLAYER_CHAT, EVENT_PLAYER_END_CINEMATIC, EVENT_PLAYER_UNIT_ATTACKED, EVENT_PLAYER_UNIT_RESCUED, EVENT_PLAYER_UNIT_DEATH, EVENT_PLAYER_UNIT_DECAY, EVENT_PLAYER_UNIT_DETECTED, EVENT_PLAYER_UNIT_HIDDEN, EVENT_PLAYER_UNIT_SELECTED, EVENT_PLAYER_UNIT_DESELECTED, EVENT_PLAYER_UNIT_CONSTRUCT_START, EVENT_PLAYER_UNIT_CONSTRUCT_CANCEL, EVENT_PLAYER_UNIT_CONSTRUCT_FINISH, EVENT_PLAYER_UNIT_UPGRADE_START, EVENT_PLAYER_UNIT_UPGRADE_CANCEL, EVENT_PLAYER_UNIT_UPGRADE_FINISH, EVENT_PLAYER_UNIT_TRAIN_START, EVENT_PLAYER_UNIT_TRAIN_CANCEL, EVENT_PLAYER_UNIT_TRAIN_FINISH, EVENT_PLAYER_UNIT_RESEARCH_START, EVENT_PLAYER_UNIT_RESEARCH_CANCEL, EVENT_PLAYER_UNIT_RESEARCH_FINISH, EVENT_PLAYER_UNIT_ISSUED_ORDER, EVENT_PLAYER_UNIT_ISSUED_POINT_ORDER, EVENT_PLAYER_UNIT_ISSUED_TARGET_ORDER, EVENT_PLAYER_HERO_LEVEL, EVENT_PLAYER_HERO_SKILL, EVENT_PLAYER_HERO_REVIVABLE, EVENT_PLAYER_HERO_REVIVE_START, EVENT_PLAYER_HERO_REVIVE_CANCEL, EVENT_PLAYER_HERO_REVIVE_FINISH, EVENT_PLAYER_UNIT_SUMMON, EVENT_PLAYER_UNIT_DROP_ITEM, EVENT_PLAYER_UNIT_PICKUP_ITEM, EVENT_PLAYER_UNIT_USE_ITEM, EVENT_PLAYER_UNIT_LOADED
    LPEVENT nextPlayer; // for player events
    LPEVENT nextUnit; // for unit events
    LPEVENT nextWidgetDeath; // for widget death events
    LPEDICT widget; // for widget death events
    LPEVENT nextUnitInRange; // for EVENT_UNIT_IN_RANGE
    LPEDICT unitInRange; // for EVENT_UNIT_IN_RANGE
    LPEVENT nextGameEvent; // for game events
    LPEDICT gameEntity; // for game events
    LPEVENT nextGameVariableLimit; // for EVENT_GAME_VARIABLE_LIMIT
    LPEDICT gameVariableLimit; // for EVENT_GAME_VARIABLE_LIMIT
    LPEVENT nextGameStateLimit; // for EVENT_GAME_STATE_LIMIT
    LPEDICT gameStateLimit; // for EVENT_GAME_STATE_LIMIT       
    LPTIMER timer;
    REGION region;
    HANDLE filter; // for EVENT_GAME_ENTER_REGION, EVENT_GAME_LEAVE_REGION
    FLOAT range;
};
